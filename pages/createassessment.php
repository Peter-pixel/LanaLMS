...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    ...
    <div id="content" class="three_quarter"> 
            <h1>Upload Assessments</h1>
            <form action="createassessment_action.php" method="post" enctype="multipart/form-data">
...
<input type="date" placeholder="Date" name="duedate" required><br>
...
<div class="center push30">
        <h1 class="shout">Submitted assessments</h1>
    </div>
<div style="height:150px;width:100%;overflow:auto;background-color:green;color:black;scrollbar-base-color:blue;font-family:sans-serif;padding:10px;">
    ...
    <?php
 $sql="SELECT * FROM submitassessment";
 ...
 while($row = $result_set->fetch_assoc())
 {
  ?>
        ...
        <td><a href="../submitedassessments/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
        </tr>
        <?php
 }
 ?>
