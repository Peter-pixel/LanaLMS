...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    ...
    <div class="center push80">
      <h1 class="shout">You can share your thoughts with other learners here.</h1>
      
    </div>
    <iframe src='https://deadsimplechat.com/XqAYOwJzR' width='100%' height='600px'></iframe>
  </main>
</div>
