<?php
    ...
    if (isset($_SESSION['loggedIn_InstructorId'])) {
        $sql0 = "SELECT * FROM instructor WHERE InstructorId=".$_SESSION['loggedIn_InstructorId'];
    ...
    <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li class="active"><a href="instructorhome.php">Home</a></li>
              <li><a href="instructorannouncements.php">Announcements</a></li>
              <li><a href="foruminstructor.php">Forum &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a></li>
